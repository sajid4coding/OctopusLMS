...
<head>
    ...
    <title>Edukon</title>
    <link rel="shortcut icon" href="{{ asset('frontend_asset') }}/images/x-icon.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('frontend_asset') }}/css/icofont.min.css">
    <link rel="stylesheet" href="{{ asset('frontend_asset') }}/css/swiper.min.css">
    <link rel="stylesheet" href="{{ asset('frontend_asset') }}/css/lightcase.css">
...
<body>
        ...
        <div class="header-bottom">
            <div class="container">
                <div class="header-wrapper">
                    <div class="logo">
                        <a href="index.html"><img src="{{ asset('frontend_asset') }}/images/logo/01.png" alt="logo"></a>
                    </div>
                    <div class="menu-area">
                        <div class="menu">
                            <ul class="lab-ul">
                        ...
                        <a href="{{ route('login.field') }}" class="login"><i class="icofont-user"></i> <span>LOG IN</span> </a>
                        <a href="{{ route('customer.create') }}" class="signup"><i class="icofont-users"></i> <span>SIGN UP</span> </a>
    ...
    <div class="news-footer-wrap">
        <div class="fs-shape">
            <img src="{{ asset('frontend_asset') }}/images/shape-img/03.png" alt="fst" class="fst-1">
            <img src="{{ asset('frontend_asset') }}/images/shape-img/04.png" alt="fst" class="fst-2">
        </div>
    ...
    <script src="{{ asset('frontend_asset') }}/js/progress.js"></script>
    <script src="{{ asset('frontend_asset') }}/js/lightcase.js"></script>
    <script src="{{ asset('frontend_asset') }}/js/counter-up.js"></script>
    <script src="{{ asset('frontend_asset') }}/js/isotope.pkgd.js"></script>
