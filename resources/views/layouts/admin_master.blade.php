...
<!-- Mirrored from gambolthemes.net/html-items/cursus_main_demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 May 2023 17:25:34 GMT -->
...
<head>
    ...
    <title>Octopus A Learning Managment System</title>

    <link rel="icon" type="image/png" href="{{ asset('dashboard_asset') }}/images/fav.png">

    <link href="https://fonts.googleapis.com/css?family=Roboto:400,700,500" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/vendor/unicons-2.0.1/css/unicons.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/css/vertical-responsive-menu.min.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/css/style.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/css/responsive.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/css/night-mode.css" rel="stylesheet">

    <link href="{{ asset('dashboard_asset') }}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/vendor/OwlCarousel/assets/owl.carousel.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/vendor/OwlCarousel/assets/owl.theme.default.min.css" rel="stylesheet">
    <link href="{{ asset('dashboard_asset') }}/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_asset') }}/vendor/semantic/semantic.min.css">
...
<body>
    ...
    <header class="header clearfix">
        ...
        <div class="main_logo" id="logo">
            <a href="index.html"><img src="{{ asset('dashboard_asset') }}/images/logo.svg" alt></a>
            <a href="index.html"><img class="logo-inverse" src="{{ asset('dashboard_asset') }}/images/ct_logo.svg" alt></a>
        </div>
            ...
            <ul>
                ...
                <li class="ui dropdown">
                    <a href="#" class="opts_account" title="Account">
                        <img src="{{ asset('dashboard_asset') }}/images/hd_dp.jpg" alt>
                    </a>
                            ...
                            <div class="profile_link">
                                ...
                                <div class="pd_content">
                                    ...
                                    <span><a href="https://gambolthemes.net/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="c7a0a6aaa5a8abfef3f487a0aaa6aeabe9a4a8aa">[email&#160;protected]</a></span>
                                </div>
                            </div>
                ...
                <ul>
                    ...
                    <li class="menu--item menu--item__has_sub_menu">
                        ...
                        <ul class="sub_menu">
                            <li class="sub_menu--item">
                                <a href="{{ route('add.user') }}" class="sub_menu--link">Add User</a>
                            </li>
                    ...
                    <li class="menu--item  menu--item__has_sub_menu">
                        <label class="menu--link" title="Tests">
                            ...
                            <span class="menu--label">Role Managment</span>
                        </label>
                        <ul class="sub_menu">
                            <li class="sub_menu--item">
                                <a href="{{ route('add.role') }}" class="sub_menu--link">Add Role</a>
                            </li>
                            <li class="sub_menu--item">
                                {{-- <a href="{{ route('create.permission') }}" class="sub_menu--link">Add Permission</a> --}}
                            </li>
                            <li class="sub_menu--item">
                                <a href="{{ route('assign.role.permission') }}" class="sub_menu--link">Assign Permission</a>
                            </li>
    ...
    {{-- ===========================================
                            Body Content End
        ============================================ --}}
   <footer class="footer mt-30" style="position: relative;bottom:0;">
            <div class="container">
                <div class="row">
                                        ...
                                        <li>
                                            <a href="index.html">
                                                <div class="footer_logo">
                                                    <img src="{{ asset('dashboard_asset') }}/images/logo1.svg" alt>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
    ...
    <script src="{{ asset('dashboard_asset') }}/js/vertical-responsive-menu.min.js"></script>
    ...
    <script src="{{ asset('dashboard_asset') }}/vendor/OwlCarousel/owl.carousel.js"></script>
    <script src="{{ asset('dashboard_asset') }}/vendor/semantic/semantic.min.js"></script>
    <script src="{{ asset('dashboard_asset') }}/js/custom.js"></script>
    <script src="{{ asset('dashboard_asset') }}/js/night-mode.js"></script>
    @yield('script_body')
</body>
